...
const Navbar = () => {
  ...
  return (
    <header className='overscroll-none relative nothing-here-in-md '>
      <div className={` transition-all duration-300 ease-in-out ${isOpen? '  fixed  bottom-0 h-[100lvh] w-full bg-black z-[1000] opacity-100':' w-full  z-[1000] fixed  top-0 py-3.5 px-3  mx-auto gradient flex  justify-between items-center'}       `}>
